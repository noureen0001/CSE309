...
<div style="width: 50%; background-color: rgb(181, 226, 222); margin-left: 30%; border-radius: 5px; border-style: none; padding: 5px; font-family: tahoma;">
    ...
    <button style="background-color: black; border-style: none; border-radius: 5px; width: 10%; font-family: tahoma; color: white"><a style="color: white; text-decoration:none;" href="datavisualize.php">Male and Female Graph</button>
